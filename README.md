...
This repository documents my complete **160-day journey** of learning Java and Data Structures & Algorithms from absolute scratch — with the goal of cracking technical placements.
...
```
Phase 1 ──────── Java Fundamentals        [Day 001–021]  🔄 In Progress
Phase 2 ──────── Advanced Java + Basics   [Day 022–045]  ⏳ Upcoming
Phase 3 ──────── Core DSA                 [Day 046–100]  ⏳ Upcoming
...
| Day 09–12 | Arrays — 1D + 2D, Manipulation | ⬜ |
| Day 13–15 | Strings — Methods, StringBuilder, Patterns | ⬜ |
| Day 16–18 | OOP — Classes, Objects, Constructors, `this` | ⬜ |
...
| Days | Topic | Status |
|------|-------|--------|
| Day 22–25 | Collections — ArrayList, HashMap, HashSet, Stack, Queue | ⬜ |
...
| Days | Topic | Status |
|------|-------|--------|
| Day 101–115 | Graphs — BFS, DFS, Dijkstra, Cycle Detection, Toposort | ⬜ |
| Day 116–136 | Dynamic Programming — Memo → Tabulation → Optimization | ⬜ |
...
> 💡 Click any day number to open its full detailed report.
...
```
1. 🧠  Understand WHY — never just memorize
2. 💻  Code every concept — no passive reading
3. ❌  Document every mistake — they are free lessons
4. 🔁  Revise regularly — spaced repetition wins
5. 📈  Solve problems daily — consistency > intensity
6. 🗣️  Explain out loud — Feynman Technique
7. 🏋️  Stay uncomfortable — growth lives at the edge
8. ⏰  5 hours every day — no excuses, no shortcuts
```
